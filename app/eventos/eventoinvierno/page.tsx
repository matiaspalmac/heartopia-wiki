...
import { Snowflake, Calendar, Coins, ExternalLink, Timer, MessageSquare, Copy } from "lucide-react";
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mt-24 p-10 rounded-[3rem] bg-blue-50 dark:bg-zinc-900/50 border-2 border-dashed border-blue-200 dark:border-zinc-800 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Estamos trabajando en traducir todos los nombres de los objetos a su versión oficial en español. Si conoces el nombre de alguno, ¡Contactame en Discord!
          </p>
