          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div className="text-center lg:text-left space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/20 px-4 py-1.5 rounded-full">
                ...
                <p className="mx-auto lg:mx-0 max-w-xl text-lg text-muted-foreground leading-relaxed">
                  Bienvenido a la Wiki creada por <strong>nuestra comunidad</strong>. Centralizamos toda la información del pueblito para que ningún vecino se pierda de nada.
                </p>
                
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  <Button size="lg" className="h-14 px-8 rounded-2xl gap-2 text-base font-bold shadow-xl shadow-primary/20 transition-all hover:scale-105" asChild>
                    <Link href="/buscar">
                      Explorar la Wiki <ArrowRight className="h-5 w-5" />
                    </Link>
                  </Button>
                  <Button size="lg" variant="outline" className="h-14 px-8 rounded-2xl gap-2 text-base font-bold border-2 bg-background/50 backdrop-blur-sm" asChild>
                ...
                <div className="flex items-center justify-center lg:justify-start gap-3 pt-4">
                  <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-secondary/50 border border-border">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Creado con ❤️ por <span className="text-foreground font-bold">Dei</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-8 bg-secondary/10 border-y border-border/50 backdrop-blur-sm">
          <div className="mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
                <p className="text-sm font-black uppercase tracking-tighter text-primary">Nuestra Base de Datos</p>
                <p className="text-xs text-muted-foreground">Documentando cada secreto del pueblito</p>
            </div>
            <div className="flex flex-wrap justify-center gap-3">
              {CATEGORIES.map((cat) => {
                ...
                return (
                  ...
                  >
                    <div className={`p-1.5 rounded-full ${categoryColors[cat.id]?.split(' ')[0]}`}>
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="mb-16 space-y-4 text-center">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                Toda la información ha sido recolectada y verificada por los jugadores de <strong>Heartopia Chile</strong>.
              </p>
            </div>
                    ...
                    <Card className="group h-full border-2 border-transparent bg-card/50 transition-all hover:border-primary/20 hover:bg-card hover:shadow-2xl overflow-hidden">
                      <CardHeader className="pb-4">
                        <div className="flex items-center justify-between">
                          <div className={`rounded-2xl p-4 border shadow-inner ${categoryColors[cat.id]}`}>
        ...
        <section className="py-20 mb-20">
            <div className="mx-auto max-w-5xl px-4">
                <div className="rounded-[3rem] bg-primary p-8 md:p-16 text-primary-foreground text-center relative overflow-hidden">
                    ...
                    <h2 className="text-3xl md:text-5xl font-black mb-6 relative z-10">¿Falta información?</h2>
                    <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto relative z-10">
                        Esta wiki crece gracias a ti. Si encontraste un pez nuevo o un horario diferente, únete a nuestro Discord y ayúdanos a completar la guía más grande de Chile.
                    </p>
                    <Button size="lg" variant="secondary" className="h-14 px-10 rounded-2xl font-black text-lg hover:scale-110 transition-transform shadow-xl" asChild>
                        <a href="https://discord.gg/wnkBUBbaRW" target="_blank" rel="noopener noreferrer">
                            ¡Quiero Colaborar!
                        </a>
                    </Button>
